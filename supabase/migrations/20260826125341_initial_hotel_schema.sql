...
-- Seed accounts. All passwords below are 'demo123' except the owner, which is
-- 'ChangeMe123!' — change them immediately after first login.
insert into user_accounts (email, name, role, password_hash) values
  ('owner@haven.test', 'Amelia Hart', 'owner', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae'),
  ('admin@haven.test', 'Noah Santos', 'admin', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae'),
  ('manager@haven.test', 'Maya Reyes', 'manager', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae'),
  ('frontdesk@haven.test', 'Liam Cruz', 'front_desk', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae'),
  ('housekeeping@haven.test', 'Sofia Lim', 'housekeeping', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae'),
  ('maintenance@haven.test', 'Ethan Tan', 'maintenance', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae'),
  ('accounting@haven.test', 'Chloe Garcia', 'accounting', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae'),
  ('guest@haven.test', 'Jamie Lee', 'guest', '$2b$10$3BoStqdV6TDqoMO1TT.w0.xO6YVx.VkFSn8QTSaO1Fao77lsvexae')
